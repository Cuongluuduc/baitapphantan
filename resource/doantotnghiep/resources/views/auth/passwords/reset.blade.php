     ...
     <div  class="panel panel-primary">
                   <div class="panel-heading"><span class="glyphicon glyphicon-align-left" aria-hidden="true"></span> Đổi Mật khẩu</div>
                     <div class="panel-body">
                       <form action="{!!url('password/reset')!!}" method="POST" style="">
                        <input type="hidden" name="_token" value="{!!csrf_token()!!}"/>
                        <input type="hidden" name="token" value="{{ $token }}">
                         <label for="">Email</label>
                         <input type="text" class="form-control" id="" placeholder="email" name="email" value=""> 
                         <label for="">Password</label>
                         <input type="text" class="form-control" id="" placeholder="Password" name="password"> 
                         <label for="">Comfirm Password</label>
                         <input type="text" class="form-control" id="" placeholder="" name="password_confirmation"> 
                         <button style="margin-top: 5px;" type="submit" class="btn btn-primary"> Thay đổi </button>   
                         <div class="panel panel-primary">
