...
<div class="panel panel-heading">Xác nhận khách hàng</div>
     <?php
      $today = date('d-m-Y');
      echo "Xác nhận khách hàng ngày:".$today;
     ?>
      @if(Session::has('xacnhan_message'))
            <div class="alert alert-success">
              {!! Session::get('xacnhan_message')!!}
            </div>
        @elseif(Session::has('doi_message'))
            <div class="alert alert-success">
              {!! Session::get('doi_message')!!}
            </div>
        @elseif(Session::has('pc_message'))
            <div class="alert alert-success">
              {!! Session::get('pc_message')!!}
            </div>
        @elseif(Session::has('kpc_message'))
            <div class="alert alert-danger">
              {!! Session::get('kpc_message')!!}
            </div>
      @endif
      ...
      ?>
        ...
        <?php $i++?>
            <tr> 
                ...
                <a href="{!! route('adminsts_phancong',['id'=>$item["id"]]) !!}"><button type="button" class="btn btn-success"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></button></a>
                ...
                <div class="modal fade" id="{{$item->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                  ...
                  <form action="adminsts_xacnhan" method="POST" role="form">
                  ...
                  <form action="adminsts_doilaixe" method="POST" role="form">
                  <input type="hidden" name="_token" value="{!!csrf_token()!!}"/>
