...
<div class="panel panel-heading">Vé thông tin vé</div>

	<div class="panel-body">
  
		<table id="khachxemve" class="table table-striped table-bordered" cellspacing="0" width="100%" style="font-size: 12px;">
        <thead>
            <tr>
                <th>STT</th>
                <th>Ngày</th>
                ...
                <th>Tuyến</th>
                <th>Thời gian</th>
                <th style="min-width: 61px;">Xem</th>
            </tr>
        </thead>
        <tfoot>
            <tr>
        ...
        <?php $i++?>
            <tr> 
                ...
                <td><a href="home"><button type="button" class="btn btn-danger"><span class="glyphicon glyphicon-hand-right" aria-hidden="true"></span></button></a>
